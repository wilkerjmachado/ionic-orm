 ...
 */
export class IonicSQLiteDriver {
    // -------------------------------------------------------------------------
    // Constructor
    // -------------------------------------------------------------------------
    ...
    connect() {
        return new Promise((ok, fail) => {
            ...
            const connection = sqlite.create({ name: String(this.options.database), location: 'default' });
            if (!connection)
                return fail();
...
//# sourceMappingURL=IonicSQLiteDriver.js.map