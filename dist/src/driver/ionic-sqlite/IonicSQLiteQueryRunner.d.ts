 ...
 */
export declare class IonicSQLiteQueryRunner implements QueryRunner {
    ...
    constructor(databaseConnection: DatabaseConnection, driver: IonicSQLiteDriver, logger: Logger);
    /**
